...
export const navItems: NavItem[] = [
  ...
  { id: 'layout-pattern', label: 'Layout Pattern', section: 'Core Patterns' },
  { id: 'metadata', label: 'Metadata', section: 'Advanced Patterns' },
  {
    id: 'server-actions',
  ...
  { id: 'streaming', label: 'Streaming', section: 'Advanced Patterns' },
];
