/**
 * Next.js config wrapper that injects PinFlow transforms for both
 * Turbopack and Webpack bundler paths.
 *
 * @module @pinflow/next/with-pinflow
 */
...
import type { PinFlowNextOptions } from './types.js';
...
/**
 * Apply PinFlow dev-time transforms for both Turbopack and Webpack.
 */
...
/**
 * Build a webpack function that applies PinFlow transforms for Next.js.
 *
