...
> {
  ...
  description =
    'List PinFlow annotations for monitoring and review purposes. ' +
    'To process the NEXT queued annotation, use pinflow.annotation.process instead — it atomically claims and returns full context in one call. ' +
